...
public class URLs {
	...
	public static final String API_URL = "http://42.96.134.201:8080/gamelearning/clientLogin/login.action?";//登录
	public static final String qIANDAOTIME=HOST+"signIn/signInTimes.action?";
...
public static final String RULE="http://42.96.134.201:8080/gamelearning/clientGame/getGameRule.action?";//游戏规则
