...
public class SoundDialog extends Dialog {
	 ...
	 * @param listener
	 */
	public SoundDialog(Context context, int layoutResID, int mystyle,onDialogClickListener listener) {
	...
	public interface onDialogClickListener {
		/** 绑定监听 */
		public void onDialogViewClick(SoundDialog dialog, android.view.View.OnClickListener listener);
	}
}
