...
public class MyDialog extends Dialog {
	 ...
	 * @param listener
	 */
	public MyDialog(Context context, int layoutResID, int mystyle,onDialogClickListener listener) {
	...
	public interface onDialogClickListener {
		/** 绑定监听 */
		public void onDialogViewClick(MyDialog dialog, android.view.View.OnClickListener listener);
	}
}
