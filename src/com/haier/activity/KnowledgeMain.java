 ...
 * @author guolin
 */
public class KnowledgeMain extends FragmentActivity implements OnClickListener {
	/**
	 * 用于展示消息的Fragment
	 */
	...
	private RuleFragment settingFragment;
	/**
	 * 用于展示选择游戏的界面
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.knowledgemain);
		// 初始化布局元素
		initViews();
	...
	private void setTabSelection(int index) {
		...
		default:
			...
			if (settingFragment == null) {
				...
				settingFragment = new RuleFragment();
