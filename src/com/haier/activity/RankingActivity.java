...
public class RankingActivity extends Activity implements OnClickListener{
	...
	@ViewInject(R.id.right_button)  private  Button searchButton;
	@ViewInject(R.id.newslistview)
	private PullToRefreshListView news_list;
	@ViewInject(R.id.remindbtn) 
	...
	private void inview() {
		// TODO Auto-generated method stub
		newsListAdapter = new RankingListAdapter(this, news);
		mNewsFooter = this.getLayoutInflater().inflate(
    ...
    @OnClick({R.id.left_button,R.id.right_button,R.id.remindbtn})
	@Override
	public void onClick(View arg0) {
    	...
    	case R.id.right_button:
    		Intent intent=new Intent(RankingActivity.this,SearchFrendActivity.class);
    		startActivity(intent);
    		break;
    	case R.id.remindbtn:
    		Intent intent1=new Intent(RankingActivity.this,RemindFsActivity.class);
