...
import com.haier.R;
import com.haier.adapter.CarefulPagerAdapter;

public class CarefulFragment extends Fragment {
	private ViewPager mGamePager;
	private CarefulPagerAdapter mPagerAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View settingLayout = inflater.inflate(R.layout.secectgame, container,
				false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mPagerAdapter = new CarefulPagerAdapter(getChildFragmentManager(),
				getActivity());
