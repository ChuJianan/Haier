...
import com.haier.R;
import com.haier.activity.forum.AskAllReplyActivity;
...
public class AskAllFragment extends BaseFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view=inflater.inflate(R.layout.fragment_glory_dq, null);
		...
		// TODO Auto-generated method stub
				...
				news_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
		        		...
		        		Intent intent = new Intent(getActivity(), AskAllReplyActivity.class);
	...
	private void loadNewsDatas(final Handler handler,final int pageNo, final int action){
		new Thread(){
			public void run() {
				...
				try {
					Askalls list=Askalls.parse(AppClient.httpgetAsk(URLs.ASK_URL+"sessionId="+Sscion.getSsid()+"&"+"pageno="+pageNo));
