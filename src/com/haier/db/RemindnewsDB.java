...
public class RemindnewsDB {

	public final static String TABLE_NAME = "remindnews";
	public final static String ID = "id";
	public final static String STATUS = "remindInfos";
	private DBHelper helper;
	public RemindnewsDB(Context context) {
	...
	public String select() {
		...
		Cursor cursor = db.rawQuery("select * from remindnews", null);
