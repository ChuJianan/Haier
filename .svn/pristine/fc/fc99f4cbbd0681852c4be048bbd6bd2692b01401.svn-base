...
import com.haier.R;
import com.haier.adapter.GloryBmListAdapter;
...
public class GloryBmFragment extends Fragment{
	...
	private int pageNo = 3;//当前页数
	private int pageSize = 200;//每页个数
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view=inflater.inflate(R.layout.fragment_glorybm, container, false);
...
//	}
	private void loaDatas() {
		...
		this.loadNewsDatas(mNewsHandler, 3, UIHelper.LISTVIEW_ACTION_INIT);
	}
	...
	private void inview() {
		// TODO Auto-generated method stub
		newsListAdapter=new GloryBmListAdapter(getActivity(),news);
