...
public class ScheduleInfosContentProvider extends ContentProvider{
    ...
    static{  
        ...
        MATCHER.addURI("com.haier.ContentProvider.ScheduleInfosContentProvider", "schedules", USERS);  
        //如果match()方法匹配content://com.yaku.ContentProvider.userprovider/user/123路径，返回匹配码为2  
        MATCHER.addURI("com.haier.ContentProvider.ScheduleInfosContentProvider", "schedules/#", USER);//#号为通配符  
    }     
	@Override
...
//获得类型
	...
	public Uri insert(Uri uri, ContentValues values) {
        ...
        //插入数据，返回行号ID
        long rowid=db.insert("schedules", "knowledgeId", values);
        //如果插入成功，返回Uri
        if(rowid>0)
        {
