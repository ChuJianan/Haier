...
public class RemindfzDB {

	public final static String TABLE_NAME = "remindfz";
	public final static String ID = "id";
	public final static String STATUS = "remindInfos";
	private DBHelper helper;
	public RemindfzDB(Context context) {
	...
	public String select() {
		...
		Cursor cursor = db.rawQuery("select * from remindfz", null);
