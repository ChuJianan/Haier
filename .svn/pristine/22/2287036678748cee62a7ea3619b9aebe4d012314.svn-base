...
//		public TextView author;
	...
	public NoticesListAdapter (Context context,List<INews> list){
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			convertView = listContainer.inflate(R.layout.activity_notices_list_item, null);
		...
		INews iNews=list.get(arg0);
		holder.title.setText(iNews.getTitle());
		return convertView;
	}
	@Override
	public int getCount() {
