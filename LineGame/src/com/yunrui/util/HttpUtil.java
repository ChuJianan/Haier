...
public class HttpUtil {
	...
	public static String url="http://58.56.163.30:8080/gamelearning/clientGame/getResults.action?";
	...
	public static String getQuset() {
		...
		String result = null;
		HttpGet httpRequest = new HttpGet("http://58.56.163.30:8080/gamelearning/clientGame/getQuestions.action?"+"knowledgeId="+TestUtil.kid+"&sessionId="+TestUtil.ssid); 
